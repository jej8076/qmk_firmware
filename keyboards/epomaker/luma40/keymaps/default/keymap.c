...
// Define custom keycode for Hold-Tap Space (Hold: F18, Tap: Space)
enum custom_keycodes {
    SPACE_HT = SAFE_RANGE
};

// Timer and state variables for custom hold-tap logic
static uint16_t space_ht_timer = 0;
static bool space_ht_registered = false;
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_tkl_ansi(
        ...
        //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
             KC_NO,    KC_NO,   KC_NO,  KC_LALT, KC_LGUI,                               SPACE_HT,  MO(1),   MO(2),  KC_F13,   KC_NO,   KC_NO
    ),
    ...
    [1] = LAYOUT_tkl_ansi(
        ...
        //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
             KC_NO,    KC_NO,   KC_NO,  KC_LALT, KC_LGUI,                               SPACE_HT,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO
    ),

    [2] = LAYOUT_tkl_ansi(
        //,-----------------------------------------------------.                    ,-----------------------------------------------------.
             KC_TAB,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                          KC_NO,    KC_7,    KC_8,    KC_9,    KC_0,  KC_BSPC,
        //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
            KC_LCTL,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,                          KC_NO,    KC_4,    KC_5,    KC_6,   KC_NO,  KC_ENT,
        //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
            KC_LSFT,  KC_F11,  KC_F12,   KC_NO,   KC_NO,   KC_NO,                          KC_NO,    KC_1,    KC_2,    KC_3,   KC_NO,  KC_RSFT,
        //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
             KC_NO,    KC_NO,   KC_NO,  KC_LALT, KC_LGUI,                               SPACE_HT,  KC_NO,   KC_NO,    KC_0,   KC_NO,   KC_NO
    ),

    [3] = LAYOUT_tkl_ansi(
        //,-----------------------------------------------------.                    ,-----------------------------------------------------.
             KC_TAB, MD_BLE1, MD_BLE2, MD_BLE3,  MD_24G,   KC_NO,                         KC_NO,   KC_NO,   KC_NO,   MS_UP,   KC_NO,  KC_BSPC,
        //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
            KC_LCTL,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,                         KC_NO,   KC_NO, MS_LEFT, MS_DOWN, MS_RGHT,  KC_ENT,
        //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
            KC_LSFT,   KC_NO,   KC_NO,   KC_NO,   KC_NO,  EE_CLR,                         KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,  KC_RSFT,
        //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
             KC_NO,    KC_NO,   KC_NO,  KC_LALT, KC_LGUI,                               SPACE_HT,  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO
    )
};
...
// Custom behavior for SPACE_HT (Hold: F18, Tap: Space)
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        case SPACE_HT:
            if (record->event.pressed) {
                space_ht_timer = timer_read();
                space_ht_registered = false;
            } else {
                if (space_ht_registered) {
...
// Check timer to activate hold key (F18) after 200ms
void matrix_scan_user(void) {
    if (space_ht_timer != 0 && !space_ht_registered && timer_elapsed(space_ht_timer) >= 200) {
        register_code(KC_F18);
        space_ht_registered = true;
    }
}
